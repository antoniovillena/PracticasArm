...
{\tt GPFEN0}, en concreto las que entran por los pulsadores (GPIO 2 y GPIO 3). 
...
Lo nuevo que vemos aquí es una escritura en el puerto {\tt GPFEN0}. De esta forma
le decimos al controlador de interrupciones que esos pines del GPIO serán los únicos que
provoquen interrupciones, concretamente flancos con de bajada síncronos (justo
