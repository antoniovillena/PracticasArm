...
El código del listado \ref{fig:2.10} está en el fichero {\tt tipos3.s}. Compila y
...
cursor, sitúate sobre la instrucción {\tt JMP bucle1} y pulsa \fbox{F10}, opción
...
programa con un {\it run} (\fbox{F10}, opción {\bf R}un, subopción {\bf
R}un, o el
cortocircuito \fbox{F9}). En este caso, el programa se ejecturá hasta que
encuentre una instrucción con un {\it breakpoint} o hasta que el programa
finalice. Si ejecutamos con \fbox{F9}, veremos que siempre nos detenemos en
