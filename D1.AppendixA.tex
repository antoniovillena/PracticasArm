...
{\tt ADDEXC} y de los parámetros {\tt par1, par2} separados por coma.
...
{\tt \textbackslash par1} y {\tt \textbackslash par2} para acabar con {\tt .endm}.
...
La dirección actual es {\tt \textbackslash par1}, la de la RTI
es {\tt \textbackslash par2} y hay que restarle 8 por el
segmentado de la CPU.
\\
{\it instrucción }$ = (\textbackslash par2-\textbackslash par1-8)/4 + 0xEA000000$ \\
{\it instrucción }$ = (\textbackslash par2-\textbackslash par1)/4 + 0xE9FFFFFE$
