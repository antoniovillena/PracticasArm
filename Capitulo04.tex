...
Para nuestros propósitos de esta lección nos basta con acceder a los registros GPFSELx,
GPSETx y GPCLRx. A continuación tenemos la tabla con las direcciones de estos registros.

\begin{longtable}{ p{1.8cm} | p{2cm} | p{5cm} | p{1cm} | p{1cm} }
\hline
{\bf Dirección} & {\bf Nombre} & {\bf Descripción} & {\bf Tam.} & {\bf Tipo} \\ \hline
20200000 & GPFSEL0 & Selector de función 0 & 32 & R/W \\ \hline
20200004 & GPFSEL1 & Selector de función 1 & 32 & R/W \\ \hline
20200008 & GPFSEL2 & Selector de función 2 & 32 & R/W \\ \hline
2020000C & GPFSEL3 & Selector de función 3 & 32 & R/W \\ \hline
20200010 & GPFSEL4 & Selector de función 4 & 32 & R/W \\ \hline
20200014 & GPFSEL5 & Selector de función 5 & 32 & R/W \\ \hline
2020001C & GPSET0  & Pin a nivel alto 0  & 32 & W   \\ \hline
20200020 & GPSET1  & Pin a nivel alto 1  & 32 & W   \\ \hline
20200028 & GPCLR0  & Pin a nivel bajo 0 & 32 & W  \\ \hline
2020002C & GPCLR1  & Pin a nivel bajo 1 & 32 & W  \\ \hline
\end{longtable}

El puerto GPIO consta de 54 señales, que separamos en 6
grupos funcionales de 10 pines cada uno (excepto el último
que es de 4) para programarlas mediante GPFSELx.
...
que la numeración empieza en 0, desde GPIO 0 hasta GPIO 53. De todas estas señales sólo
17 se corresponden con pines físicos (26 si disponemos de un modelo A+ ó B+) a través
del conector {\tt P1}.
...
con el rojo de más a la izquierda, el que queremos encender. Las posibles
